...
class UsersTableMap extends TableMap
{
     ...
     */
    const COL_ID_USER = 'users.id_user';

    /**
     * the column name for the number field
     */
    const COL_NUMBER = 'users.number';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdUser', 'Number', 'FirstName', 'LastName', 'CreatedAt', 'LastUpdated', ),
        self::TYPE_CAMELNAME     => array('idUser', 'number', 'firstName', 'lastName', 'createdAt', 'lastUpdated', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID_USER, UsersTableMap::COL_NUMBER, UsersTableMap::COL_FIRST_NAME, UsersTableMap::COL_LAST_NAME, UsersTableMap::COL_CREATED_AT, UsersTableMap::COL_LAST_UPDATED, ),
        self::TYPE_FIELDNAME     => array('id_user', 'number', 'first_name', 'last_name', 'created_at', 'last_updated', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdUser' => 0, 'Number' => 1, 'FirstName' => 2, 'LastName' => 3, 'CreatedAt' => 4, 'LastUpdated' => 5, ),
        self::TYPE_CAMELNAME     => array('idUser' => 0, 'number' => 1, 'firstName' => 2, 'lastName' => 3, 'createdAt' => 4, 'lastUpdated' => 5, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID_USER => 0, UsersTableMap::COL_NUMBER => 1, UsersTableMap::COL_FIRST_NAME => 2, UsersTableMap::COL_LAST_NAME => 3, UsersTableMap::COL_CREATED_AT => 4, UsersTableMap::COL_LAST_UPDATED => 5, ),
        self::TYPE_FIELDNAME     => array('id_user' => 0, 'number' => 1, 'first_name' => 2, 'last_name' => 3, 'created_at' => 4, 'last_updated' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('number', 'Number', 'VARCHAR', false, 1, null);
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(UsersTableMap::COL_ID_USER);
            $criteria->addSelectColumn(UsersTableMap::COL_NUMBER);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(UsersTableMap::COL_ID_USER, (array) $values, Criteria::IN);
        }
