...
abstract class Users implements ActiveRecordInterface
{
    ...
    public function setIdUser($v)
    {
        ...
        if ($this->id_user !== $v) {
            $this->id_user = $v;
            $this->modifiedColumns[UsersTableMap::COL_ID_USER] = true;
        }
    ...
    public function setNumber($v)
    {
        ...
        if ($this->number !== $v) {
            $this->number = $v;
            $this->modifiedColumns[UsersTableMap::COL_NUMBER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UsersTableMap::translateFieldName('IdUser', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_user = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UsersTableMap::translateFieldName('Number', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UsersTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UsersTableMap::translateFieldName('LastUpdated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_ID_USER)) {
            $modifiedColumns[':p' . $index++]  = 'id_user';
        }
        if ($this->isColumnModified(UsersTableMap::COL_NUMBER)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_ID_USER)) {
            $criteria->add(UsersTableMap::COL_ID_USER, $this->id_user);
        }
        if ($this->isColumnModified(UsersTableMap::COL_NUMBER)) {
            $criteria->add(UsersTableMap::COL_NUMBER, $this->number);
        }
        if ($this->isColumnModified(UsersTableMap::COL_FIRST_NAME)) {
    ...
    public function setGamesHasUserss(Collection $gamesHasUserss, ConnectionInterface $con = null)
    {
        ...
        foreach ($gamesHasUserssToDelete as $gamesHasUsersRemoved) {
            $gamesHasUsersRemoved->setUsers(null);
        }
     ...
     * @return ObjectCollection|ChildGamesHasUsers[] List of ChildGamesHasUsers objects
     */
    public function getGamesHasUserssJoinGames(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildGamesHasUsersQuery::create(null, $criteria);
